      ...
      <footer className="setu-public-footer">
        <div className="setu-public-footer-inner">
          ...
          <nav aria-label="Footer navigation" className="setu-footer-links">
            ...
            <Link href="/categories/finance">Finance &amp; insurance</Link>
          ...
          <address className="setu-footer-contact">
            <p>Contact Setu</p>
            <Link href="/support">Support and contact</Link>
            <small>Contact details are published on the support page.</small>
          </address>
        </div>
