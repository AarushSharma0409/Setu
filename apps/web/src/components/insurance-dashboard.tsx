      ...
      <PageContainer>
        <main className="mx-auto max-w-6xl space-y-7 py-8 sm:py-12">
          <header className="setu-insurance-overview-hero">
            ...
            <div className="setu-insurance-overview-progress">
              <ProgressRing label="Journey preview" value={33} />
              <p className="max-w-28 text-sm font-medium text-slate-700">
                Explore all steps before signing in.
              </p>
            </div>
          </header>
          ...
          <Card className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <Link
              ...
              href="/dev-auth?returnTo=%2Faccount%2Finsurance"
            >
              Sign in to start
            </Link>
          </Card>
