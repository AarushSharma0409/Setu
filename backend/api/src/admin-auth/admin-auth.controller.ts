...
export class AdminAuthController {
  ...
  @Get("security")
  @UseGuards(AdminAuthGuard)
  security(@CurrentUser() admin: AuthenticatedPrincipal) { return this.adminAuthService.security(admin.sub); }

  @Post("change-password")
  @UseGuards(AdminAuthGuard)
  changePassword(@CurrentUser() admin: AuthenticatedPrincipal, @Body() dto: ChangeAdminPasswordDto) { return this.adminAuthService.changePassword(admin.sub, dto.currentPassword, dto.newPassword); }

  @Post("recovery-codes/regenerate")
  @UseGuards(AdminAuthGuard)
  regenerateRecoveryCodes(@CurrentUser() admin: AuthenticatedPrincipal, @Body() dto: RegenerateRecoveryCodesDto) { return this.adminAuthService.regenerateRecoveryCodes(admin.sub, dto.code); }

  @Post("sessions/revoke-all")
  @UseGuards(AdminAuthGuard)
  revokeAllSessions(@CurrentUser() admin: AuthenticatedPrincipal) { return this.adminAuthService.revokeAllSessions(admin.sub); }
}
